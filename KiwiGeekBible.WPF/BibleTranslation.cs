...
namespace KiwiGeekBible.WPF
{
    class BibleTranslation : IBibleTranslation
    {
        ...
        public string GetBookCode(string input)
        {
            ...
            if (new[] { "DEUTERONOMY", "DEUT.", "DT.", "DE.", "DEUT", "DT", "DE" }.Contains(input)) return "DEU";
            ...
            if (new[] { "RUTH", "RUTH.", "RTH.", "RU.", "RTH", "RU" }.Contains(input)) return "RUT";
            ...
            if (new[] { "EZRA", "ERZ.", "EZ.", "ERZ", "EZ" }.Contains(input)) return "EZR";
            ...
            if (new[] { "PROVERBS", "PROV.", "PROV", "PRV.", "PRV", "PR", "PR." }.Contains(input)) return "PRO";
            ...
            if (new[] { "NAHUM", "NAH.", "NAH", "NA.", "NA" }.Contains(input)) return "NAM";
            ...
            if (new[] { "I TIMOTHY", "1 TIMOTHY", "1 TIM.", "1 TIM", "1 TI.", "1 TI", "1TIM.", "1TIM", "1TI.", "1TI" }.Contains(input)) return "1TH";
            if (new[] { "II TIMOTHY", "2 TIMOTHY", "2 TIM.", "2 TIM", "2 TI.", "2 TI", "2TIM.", "2TIM", "2TI.", "2TI" }.Contains(input)) return "2TH";
